...
def get_example_prompt():
    prompt = "RAW photo, subject, 8k uhd, dslr, high quality, Fujifilm XT3, half-length portrait from knees up, character (Scarlett Johansson): scarlett, short red hair, blue eyes"
