...
def get_example_prompt():
    prompt = "th3r0ck with no hair, muscular male, serious look on his face,RAW photo, subject, 8k uhd, dslr, high quality, Fujifilm XT3, half-length portrait from knees up, scarlett, short red hair, blue eyes, school uniform, white shirt, red tie, blue pleated microskirt"
